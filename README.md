...
This repository contains **three distinct simulation and control frameworks** designed for simulating and controlling the three 6 DOF models, **C/S Arctic Drillship**, **R/V Gunnerus** and **C/S Voyager**, under current and wave disturbances. Developed for Kristian Magnus Roen's master's thesis in Marine Cybernetics; [Meta Learning for Nonlinear Adaptive Motion Control of Marine Vessels (2025)](https://hdl.handle.net/11250/5278981), the repository includes:
