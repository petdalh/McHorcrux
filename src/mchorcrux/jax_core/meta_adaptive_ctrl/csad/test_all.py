...
from mchorcrux.jax_core.meta_adaptive_ctrl.csad.dynamics import (
    disturbance, plant_6 as plant, prior_3dof as prior,
)
...
if __name__ == "__main__":
    ...
    test_results = {
        ...
        "gains": {
            ...
            "P": (5.0, 15.0),
            # PID-only grid 
            "Kp": (jnp.array([3.16e+3,  3.1623e+3, 1.95e+2]),),
            "Ki": (jnp.array([4.55e-3, 4.2881e-3, 4.1375e-3]),jnp.array([4.55e-2, 4.2881e-2, 4.1375e-3])),
            "Kd": (jnp.array([3.1e+2, 2.24e+2, 5.7e+1]), jnp.array([3.1e+3, 2.24e+3, 7.7e+1])),
        },
    }
